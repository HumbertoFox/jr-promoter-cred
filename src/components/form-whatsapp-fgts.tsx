...
import { createDataFgts } from '@/app/api/actions/createdatafgts';
...
export default function FormWhatsappFgtsComponent() {
    const [state, action, pending] = useActionState(createDataFgts, undefined);
    ...
    return (
        <form className="w-full max-w-lg space-y-6 mx-auto" onSubmit={submit}>
            ...
            <Button
                ...
                tabIndex={4}
                disabled={pending}
                className="mt-4 w-full lg:text-sm text-xs uppercase bg-yellow-400 text-black font-bold hover:bg-yellow-500"
            >
                Solicitar
